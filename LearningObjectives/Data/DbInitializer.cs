    ...
    public static class DbInitializer
    {
        public static void Initialize(Db context)
        {
            ...
            var learningOutcomes = new LearningOutcome[]
            {
                ...
                new LearningOutcome{LearningOutcomeID=20, CourseID=4, Description="Explain the objectives and functions of abstraction layers in modern computing systems, including operating systems, programming languages, compilers, and applications."},
                new LearningOutcome{LearningOutcomeID=21, CourseID=4, Description="Understand cross-layer communications and how each layer of abstraction is implemented in the next layer of abstraction (such as how C programs are translated into assembly code and how C library allocators are implemented in terms of operating system memory management)."},
                new LearningOutcome{LearningOutcomeID=22, CourseID=4, Description="Analyze how the performance characteristics of one layer of abstraction affect the layers above it (such as how caching and services of the operating system affect the performance of C programs)."},
                new LearningOutcome{LearningOutcomeID=23, CourseID=4, Description="Construct applications using operating-system concepts (such as processes, threads, signals, virtual memory, I/O)."},
                new LearningOutcome{LearningOutcomeID=24, CourseID=4, Description="Synthesize operating-system and networking facilities to build concurrent, communicating applications."},
                new LearningOutcome{LearningOutcomeID=25, CourseID=4, Description="Implement reliable concurrent and parallel programs using appropriate synchronization constructs."},

                new LearningOutcome{LearningOutcomeID=26, CourseID=5, Description="Construct web pages using modern HTML and CSS practices, including modern frameworks."},
                new LearningOutcome{LearningOutcomeID=27, CourseID=5, Description="Define accessibility and utilize techniques to create accessible web pages."},
                new LearningOutcome{LearningOutcomeID=28, CourseID=5, Description="Outline and utilize MVC technologies across the “full-stack” of web design (including front-end, back-end, and databases) to create interesting web applications. Deploy an application to a “Cloud” provider."},
                new LearningOutcome{LearningOutcomeID=29, CourseID=5, Description="Describe the browser security model and HTTP; utilize techniques for data validation, secure session communication, cookies, single sign-on, and separate roles."},
                new LearningOutcome{LearningOutcomeID=30, CourseID=5, Description="Utilize JavaScript for simple page manipulations and AJAX for more complex/complete “single-page” applications."},
                new LearningOutcome{LearningOutcomeID=31, CourseID=5, Description="Demonstrate how responsive techniques can be used to construct applications that are usable at a variety of page sizes.  Define and discuss responsive, reactive, and adaptive."},
                new LearningOutcome{LearningOutcomeID=32, CourseID=5, Description="Construct a simple web-crawler for validation of page functionality and data scraping."}
            };
            ...
            {
                new EvaluationMetric{EvaluationMetricID=1, LearningOutcomeID=26, Name="Demonstration of HTML and CSS", Description="Students demonstrate their skills by constructing two unique HTML pages. Excellent pages should include concepts shown in lecture as well as some self-taught material.", Complete=true},
                new EvaluationMetric{EvaluationMetricID=2, LearningOutcomeID=26, Name="Quiz on CSS Theory", Description="Students are quizzed on abstract CSS concepts such as syntax, selectors, and cascading rules.", Complete=false},
            };
